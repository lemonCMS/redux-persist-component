  ...
  _createClass(PersistComponent, [{
    ...
    value: function componentDidMount() {
      ...
      this.context.store.subscribe(function () {
        ...
        (typeof _this2.props.modules === 'string' ? [_this2.props.modules] : _this2.props.modules).map(function (module) {
          var newState = (0, _get3.default)(state, module);
          if (_this2.lastState[module] !== newState) {
            _this2.props.storage.setItem(module, newState);
            _this2.lastState[module] = newState;
          }
        });
      });

      A(typeof this.props.modules === 'string' ? [this.props.modules] : this.props.modules).map(function (module) {
