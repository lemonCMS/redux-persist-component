...
var PersistComponent = function (_React$Component) {
  ...
  function PersistComponent() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PersistComponent.__proto__ || Object.getPrototypeOf(PersistComponent)).call.apply(_ref, [this].concat(args))), _this), _this.lastState = {}, _this.restored = false, _temp), _possibleConstructorReturn(_this, _ret);
  }
